...
public class Match7FinderNoneSquared : MonoBehaviour
{
    ...
    // Note This script finds Only None squared match 7, don't change make new script dumbass!
    // Note This script finds Only None squared match 7, don't change make new script dumbass!
    // Note This script finds Only None squared match 7, don't change make new script dumbass!
    // Note This script finds Only None squared match 7, don't change make new script dumbass!
    // Note This script finds Only None squared match 7, don't change make new script dumbass!
    ...
    private void RunTask()
    {
        ...
        {           
            targetSum++;
            if (IsPerfectSquare(targetSum)) { continue; }
